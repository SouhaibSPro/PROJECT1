...
//       audioRef.current.pause();
//       audioRef.current.src = process.env.PUBLIC_URL + '/kradgnikcuf-redbull-131998.mp3';
//     };
//   }, []);
...
const AudioPlayer = ({ src }) => {
  ...
  return (
    <div className='container' onClick={togglePlay}>
      <audio id="audio" src={src} />
      {isPlaying ? 
      <BsPauseFill className='icon'/> : <BsPlayFill className='icon'/>}
